...
class Quickcreator
{
	...
	public function register_connection_api_endpoints()
	{
		...
		register_rest_route(
			...
			array(
				'methods'             => 'POST',
				'callback'            => array($this, 'quickcreator_change_post_status'),
				'permission_callback' => function ($request) {
					return $this->verify_request_permission($request);
				},
				'args'                => array(),
		...
		register_rest_route(
			...
			array(
				'methods'             => 'GET',
				'callback'            => array($this, 'get_current_version'),
				'permission_callback' => function ($request) {
					return $this->verify_request_permission($request);
				},
				'args'                => array(),
	...
	{
		$headers = null;
		if (isset($_SERVER['HTTP_X_QC_TOKEN'])) {
			...
			if (isset($request_headers['X-Qc-Token'])) {
	...
	/**
	 * Return current version of Quickcreator.
	 *
	 * @return string
	 */
	public function get_current_version()
	{
		return QUICKCREATOR_BLOG_VERSION;
	}
	...
	public function quickcreator_import_post($request)
	{
		try {
			...
			$args['post_date']        = $request->get_param('publication_date') ?? '';
			...
			return new WP_REST_Response(
				array(
					'error'       => __('An exception occurred', 'quickcreator'),
	 ...
	 * 
	 */
	public function quickcreator_change_post_status($request)
	{
